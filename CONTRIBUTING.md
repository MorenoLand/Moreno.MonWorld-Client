...
- Do not add ROMs, official or extracted assets, captures, generated content, saves, or proprietary client code.
...
Describe platform coverage, direct-ROM assumptions, and validation limits in the change summary. Do not include credentials, tokens, private keys, or user-owned dump paths in issues or patches.
