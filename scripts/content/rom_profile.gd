...
static func _profile(id: String, game: String, region: String, supports_map_rendering: bool, map_groups_offset: int) -> Dictionary:
	return {"id": id, "game": game, "region": region, "revision": "header-identified", "content_id": "kanto-gba-slice-v1" if region == "Kanto" else "", "supports_map_rendering": supports_map_rendering, "map_groups_offset": map_groups_offset, "map_group_probe_indices": [0, 1, 19], "map_groups": {}, "map_names": [], "extra_maps": [], "format": {}, "animations": {}, "object_sprites": {}, "audio": {}}
